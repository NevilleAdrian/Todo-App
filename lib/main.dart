...
import 'package:morphosis_flutter_demo/non_ui/providers/provider_list.dart';
...
_openHive() async {
  ...
  Hive.registerAdapter(GetCountriesStatisticsAdapter());
  Hive.registerAdapter(CasesAdapter());
  Hive.registerAdapter(TaskAdapter());

  await HiveRepository.openHives([kCountryStatistics, kTasks]);
}
...
class _FirebaseAppState extends State<FirebaseApp> {
  ...
  //   await FirebaseManager.fireBaseProvider(context).initialise();
  //
